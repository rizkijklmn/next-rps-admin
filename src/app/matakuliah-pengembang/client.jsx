...
import TableMatkulPengembang from "./components/TableMatkulPengembang";
        ...
        <main>
            <div className="mx-10 my-3">
                <p className="text-xl font-bold tracking-normal text-gray-900 dark:text-white">
                    Halaman Daftar Mata Kuliah - Pengembang RPS
                </p>
                ...
                <Card>
                    {kurikulumId ? (
                        <TableMatkulPengembang prodiId={prodiId} kurikulumId={kurikulumId} />
                    ) : (
